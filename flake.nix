        ...
        in
        {
          default = pkgs.stdenvNoCC.mkDerivation rec {
            ...
            src = pkgs.fetchFromGitHub {
              ...
              repo = "prism-desktop";
              rev = version;
              hash = "sha256-HZiUX1uNEJZ/HGb5rZU31/U1FuZapgZVv+PhcJB+hL0=";
            };
            ...
            postPatch = ''
              ...
              p = Path("core/_generated_build_info.py")
              p.write_text(
                  '"""Auto-generated by flake.nix."""\n'
                  'BUILD_COMMIT = ${builtins.toJSON buildCommit}\n'
